...
HOSTCXXFLAGS = -pipe -DNDEBUG-fgcse-las
...
KERNELFLAGS = -pipe -DNDEBUG -Ofast -ffast-math -mtune=cortex-a7 -mcpu=cortex-a7 -marm -mfpu=neon-vfpv4 -ftree-vectorize -mvectorize-with-neon-quad -munaligned-access -fgcse-lm -fgcse-sm -fsingle-precision-constant -fforce-addr -fsched-spec-load
